...
def main():
    ...
    parser.add_argument("--out", required=True, help="Caminho do CSV de saída (ex: pipelines/bonds/us2y_daily.csv)")
    ...
    df = fetch_us2y_from_fred(api_key=api_key, series_id=args.series_id, observation_start=args.start)
